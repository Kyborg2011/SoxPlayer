...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--target-os=linux --arch=arm --enable-nonfree --disable-protocols --enable-protocol=file --disable-network --enable-avfilter --enable-cross-compile --cc=/home/user/android-ndk/build/prebuilt/linux-x86/arm-eabi-4.4.0/bin/arm-eabi-gcc --cross-prefix=/home/user/android-ndk/build/prebuilt/linux-x86/arm-eabi-4.4.0/bin/arm-eabi- --nm=/home/user/android-ndk/build/prebuilt/linux-x86/arm-eabi-4.4.0/bin/arm-eabi-nm --extra-cflags='-fPIC -DANDROID' --disable-asm --enable-neon --enable-armv5te --extra-ldflags='-Wl,-T,/home/user/android-ndk/build/prebuilt/linux-x86/arm-eabi-4.4.0/arm-eabi/lib/ldscripts/armelf.x -Wl,-rpath-link=/home/user/android-ndk/build/platforms/android-3/arch-arm/usr/lib -L/home/user/android-ndk/build/platforms/android-3/arch-arm/usr/lib -nostdlib /home/user/android-ndk/build/prebuilt/linux-x86/arm-eabi-4.4.0/lib/gcc/arm-eabi/4.4.0/crtbegin.o /home/user/android-ndk/build/prebuilt/linux-x86/arm-eabi-4.4.0/lib/gcc/arm-eabi/4.4.0/crtend.o -lc -lm -ldl'
prefix=/usr/local
...
SRC_PATH="/home/user/android-ndk-r5b/apps/HelloNDK/jni/sox/ffmpeg"
SRC_PATH_BARE=/home/user/android-ndk-r5b/apps/HelloNDK/jni/sox/ffmpeg
BUILD_ROOT="/home/user/android-ndk-r5b/apps/HelloNDK/jni/sox/ffmpeg"
CC_IDENT=gcc 4.4.0 (GCC)
ARCH=c
CC=/home/user/android-ndk/build/prebuilt/linux-x86/arm-eabi-4.4.0/bin/arm-eabi-gcc
AS=/home/user/android-ndk/build/prebuilt/linux-x86/arm-eabi-4.4.0/bin/arm-eabi-gcc
LD=/home/user/android-ndk/build/prebuilt/linux-x86/arm-eabi-4.4.0/bin/arm-eabi-gcc
DEPCC=/home/user/android-ndk/build/prebuilt/linux-x86/arm-eabi-4.4.0/bin/arm-eabi-gcc
YASM=yasm
YASMDEP=yasm
AR=/home/user/android-ndk/build/prebuilt/linux-x86/arm-eabi-4.4.0/bin/arm-eabi-ar
RANLIB=/home/user/android-ndk/build/prebuilt/linux-x86/arm-eabi-4.4.0/bin/arm-eabi-ranlib
CP=cp -p
LN_S=ln -sf
STRIP=/home/user/android-ndk/build/prebuilt/linux-x86/arm-eabi-4.4.0/bin/arm-eabi-strip
CPPFLAGS= -D_ISOC99_SOURCE -D_POSIX_C_SOURCE=200112 -D_XOPEN_SOURCE=600
...
CC_O=-o $@
LDFLAGS= -Wl,-T,/home/user/android-ndk/build/prebuilt/linux-x86/arm-eabi-4.4.0/arm-eabi/lib/ldscripts/armelf.x -Wl,-rpath-link=/home/user/android-ndk/build/platforms/android-3/arch-arm/usr/lib -L/home/user/android-ndk/build/platforms/android-3/arch-arm/usr/lib -nostdlib /home/user/android-ndk/build/prebuilt/linux-x86/arm-eabi-4.4.0/lib/gcc/arm-eabi/4.4.0/crtbegin.o /home/user/android-ndk/build/prebuilt/linux-x86/arm-eabi-4.4.0/lib/gcc/arm-eabi/4.4.0/crtend.o -lc -lm -ldl -Wl,--as-needed -Wl,--warn-common -Wl,-rpath-link,$(BUILD_ROOT)/libpostproc -Wl,-rpath-link,$(BUILD_ROOT)/libswscale -Wl,-rpath-link,$(BUILD_ROOT)/libavfilter -Wl,-rpath-link,$(BUILD_ROOT)/libavdevice -Wl,-rpath-link,$(BUILD_ROOT)/libavformat -Wl,-rpath-link,$(BUILD_ROOT)/libavcodec -Wl,-rpath-link,$(BUILD_ROOT)/libavutil
...
HOSTCC=gcc
HOSTCFLAGS=-D_ISOC99_SOURCE -O3 -g -Wall -std=c99
HOSTEXESUF=
HOSTLDFLAGS=
HOSTLIBS=-lm
TARGET_EXEC=
...
VCODEC_TESTS=asv1 asv2 dnxhd_1080i dnxhd_720p dnxhd_720p_rd dv dv50 error ffv1 flashsv2 flv h261 h263 h263p huffyuv jpegls ljpeg mjpeg mpeg mpeg1b mpeg2 mpeg2thread mpeg4 mpeg4adv mpeg4nr mpeg4thread msmpeg4 msmpeg4v2 msvideo1 qtrle qtrlegray rc rgb roq rv10 rv20 snow snowll svq1 wmv1 wmv2 yuv 
